 ...
 */
@Component
@HandlerType(value = DatePrecisionEnum.DAY)
public class DayDataQueryHandler extends AbstractEnumHandler {

    @Override
    public String handler(DatePrecisionEnum precision) {
        return String.format("this is the handler for day and param is [%s]", precision.name());
    }
